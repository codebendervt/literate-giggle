        ...
        <div className={'w-screen h-screen flex flex-col  text-white select-none  items-center justify-center md:justify-center md:items-center text-gray-900 '}>

            {
                toggle ? <p className={'text-sm w-64 md:max-w-md md:w-full md:text-lg text-center font-book'}>
                    ...
                    <p className={"text-7xl lg:text-9xl text-blue-500"}>
                        Write.
                        <br className={"md:hidden"}/>
                        <span className={'text-8xl lg:text-9xl md:text-orange-500'}>Share.
                        </span> <br className={"md:hidden"}/>
                        <span className={'text-8xl md:text-6xl lg:text-9xl text-orange-500 md:text-blue-500'}>Publish.</span>
                    </p>
                </div>
            }
            ...
            <div className={'max-w-2xl w-full flex justify-center py-2'}>
